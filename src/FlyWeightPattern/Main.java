...
public class Main {
    public static void main(String[] args)
    {
        ...
        BetterFormattedText bft = new BetterFormattedText("formula 1 is the greatest sport");
        bft.getRange(0, 8).capitalize = true;
...
class BetterFormattedText
{
    ...
    public class TextRange //This is the flyWeight
    {
